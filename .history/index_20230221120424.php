        ...
        <form class="form-default" action="login-bg.mp4" method="POST">
            ...
            <div class="login-form">
                ...
                <div class="form-input pt-30">
                    ...
                    <label for="remember" style="color: white; padding-left: 20px;">Remember me</label>
                    <input type="checkbox" name="remember" value="remember" id="remember" style="padding-left: 20px;" />
                </div>
